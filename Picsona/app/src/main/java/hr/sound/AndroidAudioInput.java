...
public class AndroidAudioInput implements AudioInputDevice {
    ...
    /**
     * Reads sound data from device. Method will always try to read length shorts.
    ...
    /**
     * Finalizes audio input and releases underlying resources. No method should be called on this object after this one.
     */
    @Override
    public void close(){
        this.record.stop();
